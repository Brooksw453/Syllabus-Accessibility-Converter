...
export async function generateAccessibleDocx(
  ...
  // Build numbering configs for each numbered list we encounter
  ...
  // Pre-scan to count numbered lists and create configs
